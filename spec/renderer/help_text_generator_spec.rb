  ...
  describe "Generating format hint for display" do
    ...
    describe "Text type questions" do
      ...
      it "should return hint with size details for question with range limits (both min and max)" do
        help_text(question_type: Question::TYPE_TEXT, string_min: 10, string_max: 25).should eq("Text between 10 and 25 characters")
      end
      it "should return hint with size details for question with range limits (both min and max the same)" do
        help_text(question_type: Question::TYPE_TEXT, string_min: 10, string_max: 10).should eq("Text 10 characters")
      end
      it "should return hint with size details for question with range limits (min only)" do
        help_text(question_type: Question::TYPE_TEXT, string_min: 10, string_max: nil).should eq("Text at least 10 characters")
      end
      it "should return hint with size details for question with range limits (max only)" do
        help_text(question_type: Question::TYPE_TEXT, string_min: nil, string_max: 25).should eq("Text a maximum of 25 characters")
      end
    end
    ...
    describe "Integer type questions" do
      ...
      it "should return hint with size details for question with range limits (max only)" do
        help_text(question_type: Question::TYPE_INTEGER, number_min: nil, number_max: 25, number_unknown: nil).should eq("Number a maximum of 25")
      end
      ...
      it "should return hint with size details for question with range limits (max only) with unknown" do
        help_text(question_type: Question::TYPE_INTEGER, number_min: nil, number_max: 25, number_unknown: 99).should eq("Number a maximum of 25 or 99 for unknown")
      end
    end
    ...
    describe "Decimal type questions" do
      ...
      it "should return hint with size details for question with range limits (max only)" do
        help_text(question_type: Question::TYPE_DECIMAL, number_min: nil, number_max: 25.3, number_unknown: nil).should eq("Decimal number a maximum of 25.3")
      end
      it "should return hint with size details for question with range limits (both min and max) with unknown" do
      ...
      it "should return hint with size details for question with range limits (max only) with unknown" do
        help_text(question_type: Question::TYPE_DECIMAL, number_min: nil, number_max: 25.3, number_unknown: 99).should eq("Decimal number a maximum of 25.3 or 99 for unknown")
      end
    end
  end
end
